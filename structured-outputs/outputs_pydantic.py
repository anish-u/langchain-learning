...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field(default=None, description="Return all the pros in a list")
    cons: Optional[list[str]] = Field(default=None, description="Return all the cons in a list")
